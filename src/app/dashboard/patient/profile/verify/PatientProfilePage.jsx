...
import { createUserdata, getUserData } from "@/src/lib/api/patients";
...
export default function PatientProfilePage() {
    ...
    // Fetch and populate profile data dynamically from API
    useEffect(() => {
    ...
    return (
        <div className="flex justify-center">
            <div className="max-w-3xl w-full space-y-6 animate-fade-in py-10 px-4 md:px-0">
                {/* Header Description */}
                <div>
                            ...
                            <div className="md:col-span-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        placeholder="123 Healthwood Drive, New York, NY"
                                        required
                                        className="w-full rounded-xl border border-slate-300 bg-white dark:border-slate-700 dark:bg-slate-950 pl-9 pr-4 py-2.5 text-sm text-slate-900 dark:text-slate-100 outline-none transition focus:border-blue-600 focus:ring-1 focus:ring-blue-600"
                                    />
                                </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <select
                                        ...
                                        onChange={handleChange}
                                        required
                                        className="w-full rounded-xl border border-slate-300 bg-white dark:border-slate-700 dark:bg-slate-950 pl-9 pr-4 py-2.5 text-sm text-slate-900 dark:text-slate-100 outline-none transition focus:border-blue-600 focus:ring-1 focus:ring-blue-600 appearance-none cursor-pointer"
                                    >
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <select
                                        ...
                                        className="w-full rounded-xl border border-slate-300 bg-white dark:border-slate-700 dark:bg-slate-950 pl-9 pr-4 py-2.5 text-sm text-slate-900 dark:text-slate-100 outline-none transition focus:border-blue-600 focus:ring-1 focus:ring-blue-600 appearance-none cursor-pointer"
                                    >
                                        <option value="" disabled>e.g. A+</option>
