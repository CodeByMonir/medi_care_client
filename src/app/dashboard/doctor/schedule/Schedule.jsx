...
export default function UpdateDoctorSchedulePage({ doctor }) {
    ...
    return (
        <div className="space-y-8 p-6 lg:p-8 bg-slate-50 dark:bg-slate-950 min-h-screen text-slate-700 dark:text-slate-300 transition-colors duration-200">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white sm:text-3xl">Update Your Schedule</h1>
                ...
                <div className="flex justify-end gap-4">
                    ...
                    >
                        {submitting ? (
                            ...
                            <>
                                <FaSave className="text-xs" /> Update Schedule
                            </>
                        )}
                    </button>
                </div>
