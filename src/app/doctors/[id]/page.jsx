...
export default async function DoctorDetailsPage({ params }) {
    ...
    // Stream document file record matching identifier via API module
    const doctor = await getDoctorsData(doctorId);
            ...
            <div className="flex min-h-[70vh] items-center justify-center px-4 bg-slate-50 dark:bg-slate-950">
                <div className="max-w-md text-center space-y-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-8 shadow-sm">
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400">
                        The clinical specialist profile for ID <span className="font-mono font-bold text-rose-600 dark:text-rose-400">{doctorId}</span> could not be verified or retrieved.
                    </p>
                    <Link
                        href="/doctors"
                    ...
                    <div className="flex-1 space-y-4 text-center md:text-left w-full">
                        <div className="space-y-1.5">
                            <div className="flex flex-wrap items-center justify-center md:justify-start gap-2">
                                ...
                                <span className="text-[10px] font-mono font-bold bg-slate-100 dark:bg-slate-800 text-slate-500 px-2 py-0.5 rounded-md border border-slate-200 dark:border-slate-700">
                    ...
                    <div className="md:col-span-1 space-y-6">
                        <div className="bg-white border border-slate-200 rounded-2xl dark:bg-slate-900 dark:border-slate-800 shadow-sm p-6 space-y-5">
                            ...
                            <div className="space-y-2.5">
                                <span className="block text-xs font-bold text-slate-400 uppercase tracking-wider flex items-center gap-1.5"><FaCalendarAlt /> Shift Timings</span>
                            ...
                            <button className="w-full inline-flex items-center justify-center gap-2 px-4 py-3 text-xs font-bold uppercase tracking-wider text-white bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 rounded-xl shadow-md transition-all">
